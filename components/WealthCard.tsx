    ...
    <div className="card-stage w-full max-w-[280px] shrink-0">
      <div className="wealth-card glass liquid-glass-chrome relative aspect-[1.586] w-full overflow-hidden rounded-[var(--radius-chrome,20px)] p-5">
        ...
        <div className="relative flex h-full flex-col justify-between">
          ...
          <div>
            <p
              className="font-semibold tabular-nums tracking-[-0.03em] text-[var(--label)]"
              style={{ fontSize: 'var(--text-title-2)', lineHeight: 'var(--leading-title-2)' }}
            >
              {formatCents(currentCents, currency, 0)}
            </p>
            <p
              className="mt-1 flex items-center gap-1 text-[var(--secondary)]"
              style={{ fontSize: 'var(--text-caption-1)', lineHeight: 'var(--leading-caption-1)' }}
            >
